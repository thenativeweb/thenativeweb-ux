...
var Logo = function Logo(_ref) {
  ...
  var componentClasses = classNames(classes.Logo, (_classNames = {}, _defineProperty(_classNames, classes.SizeM, size === 'm'), _defineProperty(_classNames, classes.SizeL, size === 'l'), _classNames));
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'g',
        null,
        React.createElement('path', { fill: '#FFFFFF', d: 'M99,80.9l-43.1,24.9L12.8,80.9V31.1L55.9,6.2L99,31.1V80.9z' }),
        React.createElement(
          'g',
          null,
