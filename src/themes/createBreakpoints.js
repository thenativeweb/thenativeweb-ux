...
const createMinWidthRule = function ({ minWidth, unit } = {}) {
...
const createMaxWidthRule = function ({ maxWidth, unit } = {}) {
...
const createMinMaxWidthRule = function ({ minWidth, maxWidth, unit } = {}) {
  if (minWidth === undefined) {
    throw new Error('Min width is missing.');
  }
  if (maxWidth === undefined) {
