...
var create = function create() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      id = _ref.id,
      _ref$brandColors = _ref.brandColors,
      brandColors = _ref$brandColors === void 0 ? defaultBrandColors : _ref$brandColors,
      _ref$interactionColor = _ref.interactionColors,
      interactionColors = _ref$interactionColor === void 0 ? defaultInteractionColors : _ref$interactionColor,
      _ref$spaceUnit = _ref.spaceUnit,
      spaceUnit = _ref$spaceUnit === void 0 ? 8 : _ref$spaceUnit,
      additionalOptions = _objectWithoutProperties(_ref, ["id", "brandColors", "interactionColors", "spaceUnit"]);

  if (!id) {
    throw new Error('Id is missing.');
  }

  var space = function space(factor) {
  ...
  var theme = _objectSpread({
    ...
    breakpoints: _objectSpread({}, (0, _createBreakpoints["default"])())
  }, additionalOptions);
