...
export type ClassDefinitions = Partial<Record<string, Record<string, NestedCssProperties> | CssAttributesFunction>>;
...
}): Partial<Record<string, NestedCssProperties>> {
  const classes: Partial<Record<string, NestedCssProperties>> = {};
...
const createDefaultSpaceDependantClasses = function ({
  ...
  let classes: Partial<Record<string, NestedCssProperties>> = {};
